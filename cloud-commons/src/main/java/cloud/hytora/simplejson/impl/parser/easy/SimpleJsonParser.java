...
public class SimpleJsonParser {
    ...
    public SimpleJsonParser(Reader reader) throws IOException {
    ...
    public JsonEntity checkTrailing(JsonEntity v) throws JsonParseException, IOException {
        this.skip();
        if (!isEndOfText()) {
                ...
                switch (first) {
                    ...
                    default:
                        if (first == '-' || first >= '0' && first <= '9') {
                            JsonEntity n = tryParseNumber(value, false);
                            if (n != null) {
                                return n;
                            }
                        }
    ...
    public static JsonEntity tryParseNumber(StringBuilder value, boolean stopAtNext) throws IOException {
    ...
    public static JsonEntity tryParseNumber(String value, boolean stopAtNext) throws IOException {
