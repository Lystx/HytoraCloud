...
public class SuggestionManager extends ListenerAdapter {
    ...
    /**
     * The file for the {@link Document}
     */
    ...
    public SuggestionManager(String channel) {
        ...
        try {
            ...
            this.jsonDocument = DocumentFactory.newJsonDocument(file);
            this.jsonDocument.saveToFile(file);
    ...
    public void save() {
        ...
        for (Suggestion pendingSuggestion : this.pendingSuggestions) {
            this.jsonDocument.set(pendingSuggestion.getUniqueId().toString(), pendingSuggestion);
        }
        this.jsonDocument.saveToFile(this.file);
    }
    ...
    public Document getJsonBuilder() {
        return jsonDocument;
    }
}
