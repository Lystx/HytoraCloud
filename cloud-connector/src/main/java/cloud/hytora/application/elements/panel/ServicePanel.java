...
public class ServicePanel extends JPanel {
    ...
    public ServicePanel() {
        ...
        trailingIconTextField.putClientProperty(FlatClientProperties.TEXT_FIELD_TRAILING_ICON,
                new FlatSVGIcon("cloud/hytora/application/icons/DataTables.svg"));
        iconsTextField.putClientProperty(FlatClientProperties.TEXT_FIELD_LEADING_ICON,
                new FlatSVGIcon("cloud/hytora/application/icons/user.svg"));
        iconsTextField.putClientProperty(FlatClientProperties.TEXT_FIELD_TRAILING_ICON,
                new FlatSVGIcon("cloud/hytora/application/icons/bookmarkGroup.svg"));
        ...
        // match case button
        JToggleButton matchCaseButton = new JToggleButton(new FlatSVGIcon("cloud/hytora/application/icons/matchCase.svg"));
        matchCaseButton.setRolloverIcon(new FlatSVGIcon("cloud/hytora/application/icons/matchCaseHovered.svg"));
        matchCaseButton.setSelectedIcon(new FlatSVGIcon("cloud/hytora/application/icons/matchCaseSelected.svg"));
        matchCaseButton.setToolTipText("Match Case");

        // whole words button
        JToggleButton wordsButton = new JToggleButton(new FlatSVGIcon("cloud/hytora/application/icons/words.svg"));
        wordsButton.setRolloverIcon(new FlatSVGIcon("cloud/hytora/application/icons/wordsHovered.svg"));
        wordsButton.setSelectedIcon(new FlatSVGIcon("cloud/hytora/application/icons/wordsSelected.svg"));
        wordsButton.setToolTipText("Whole Words");

        // regex button
        JToggleButton regexButton = new JToggleButton(new FlatSVGIcon("cloud/hytora/application/icons/regex.svg"));
        regexButton.setRolloverIcon(new FlatSVGIcon("cloud/hytora/application/icons/regexHovered.svg"));
        regexButton.setSelectedIcon(new FlatSVGIcon("cloud/hytora/application/icons/regexSelected.svg"));
