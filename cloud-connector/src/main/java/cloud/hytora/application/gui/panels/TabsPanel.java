...
public class TabsPanel extends JPanel {
    ...
    private void customComponentsChanged() {
        ...
        if (leadingComponentButton.isSelected()) {
            ...
            leading.add(new JButton(new FlatSVGIcon("cloud/hytora/application/icons/project.svg")));
        }
        if (trailingComponentButton.isSelected()) {
            trailing = new JToolBar();
            trailing.setFloatable(false);
            trailing.setBorder(null);
            trailing.add(new JButton(new FlatSVGIcon("cloud/hytora/application/icons/buildLoadChanges.svg")));
    ...
    private void initTabIconPlacement(JTabbedPane tabbedPane, int iconPlacement) {
        ...
        tabbedPane.addTab("Search", new FlatSVGIcon("cloud/hytora/application/icons/search.svg", iconSize, iconSize), null);
        tabbedPane.addTab("Recents", new FlatSVGIcon("cloud/hytora/application/icons/RecentlyUsed.svg", iconSize, iconSize), null);
        if (topOrBottom)
            tabbedPane.addTab("Favorites", new FlatSVGIcon("cloud/hytora/application/icons/favorite.svg", iconSize, iconSize), null);
    }
    ...
    private void initTabWidthMode(JTabbedPane tabbedPane, String tabWidthMode) {
        ...
        if (tabWidthMode.equals(TABBED_PANE_TAB_WIDTH_MODE_COMPACT)) {
            tabbedPane.addTab("Search", new FlatSVGIcon("cloud/hytora/application/icons/search.svg", 16, 16), null);
            tabbedPane.addTab("Recents", new FlatSVGIcon("cloud/hytora/application/icons/RecentlyUsed.svg", 16, 16), null);
            tabbedPane.addTab("Favorites", new FlatSVGIcon("cloud/hytora/application/icons/favorite.svg", 16, 16), null);
        } else {
