...
public class SQLColumn {
	...
	public SQLColumn(String name, Type varchar) {
		this(name, varchar, -1);
	}

	public SQLColumn(@Nonnull String name, @Nonnull String type,  int size) {
		this(name, type, String.valueOf(size));
	}

	public SQLColumn(@Nonnull String name, @Nonnull String type, int size, int d) {
	...
	public SQLColumn(@Nonnull String name, @Nonnull Type type, int size) {
		this(name, type.name(), size);
	}

	public SQLColumn(@Nonnull String name, @Nonnull Type type, int size, int d) {
