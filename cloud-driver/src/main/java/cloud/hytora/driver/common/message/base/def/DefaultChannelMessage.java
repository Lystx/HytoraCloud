...
public class DefaultChannelMessage implements ChannelMessage {
    ...
    @Override
    public void send() {
        IMessageChannel<ChannelMessage> genericChannel = CloudDriver.getInstance().getChannelMessenger().getRegisteredChannel(this.channel);
        genericChannel.sendMessage(this);
    }
