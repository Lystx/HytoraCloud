package cloud.hytora.driver.common.component.style;
        ...
        if (CloudDriver.getInstance() != null) {
            ...
            if (configManager != null) {
                if (configManager.getConfig() != null) {
                    ...
                    input = input.replaceAll("%1", messages.getMainColor().getColor());
                    input = input.replaceAll("%2", messages.getSecondColor().getColor());
                }
            }
        }
