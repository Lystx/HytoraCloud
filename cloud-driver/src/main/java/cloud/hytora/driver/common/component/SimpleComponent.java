package cloud.hytora.driver.common.component;


import cloud.hytora.common.random.IRandom;
import cloud.hytora.document.Document;
import cloud.hytora.driver.common.component.base.SimpleTextBase;
import cloud.hytora.driver.common.component.event.ComponentEvent;
import cloud.hytora.driver.common.component.event.click.ClickAction;
import cloud.hytora.driver.common.component.event.click.ClickEvent;
import cloud.hytora.driver.common.component.event.hover.HoverAction;
...
import cloud.hytora.driver.common.component.style.ComponentStyle;
import cloud.hytora.driver.common.component.feature.tablist.SimpleTabList;
import cloud.hytora.driver.common.component.feature.tablist.TabList;
import cloud.hytora.driver.common.component.feature.title.SimpleTitle;
import cloud.hytora.driver.common.component.feature.title.Title;
import cloud.hytora.driver.common.component.feature.ComponentOption;
        ...
        switch (state) {
            case WRITE:
                ...
                for (ComponentOption<Component, ?> option : options.keySet()) {
                    buf.writeDocument(Document.gson(option));
                }
                break;
            case READ:
