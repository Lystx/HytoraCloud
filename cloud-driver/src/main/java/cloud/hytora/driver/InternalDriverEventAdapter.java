...
public class InternalDriverEventAdapter {
    ...
    public InternalDriverEventAdapter(EventManager eventManager, AdvancedNetworkExecutor executor) {
        ...
        executor.registerPacketHandler((PacketHandler<ServerConfigurationCacheUpdatePacket>) (wrapper, packet) -> eventManager.callEvent(new TaskUpdateEvent(packet.getServiceTask())));
    }
