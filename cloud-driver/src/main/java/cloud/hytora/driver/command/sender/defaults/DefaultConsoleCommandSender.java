...
public class DefaultConsoleCommandSender implements ConsoleCommandSender {
    ...
    public void sendMessage(@NotNull String message) {
        if (CloudDriver.getInstance().getEnvironment() == CloudDriver.Environment.NODE) {
            ...
            if (CloudDriver.getInstance() == null || CloudDriver.getInstance().getConfigManager() == null || CloudDriver.getInstance().getConfigManager().getConfig() == null || CloudDriver.getInstance().getConfigManager().getConfig().getMessages() == null) {
                //do nothing
            } else {
