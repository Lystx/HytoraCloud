...
public interface PermissionManager extends PermissionChecker {
	...
	/**
	 * Returns a {@link Collection} of all {@link PermissionPlayer}s
	 * that are currently loaded into the cache
	 */
	 ...
	 */
	@Nullable
	PermissionGroup getPermissionGroup(@Nonnull String name);
	 ...
	 */
	@Nonnull
	Task<PermissionGroup> getPermissionGroupAsync(@Nonnull String name);
	 ...
	 */
	@Nullable
	PermissionPlayer getPermissionPlayer(@Nonnull UUID uniqueId);

	/**
	 * Checks if a {@link PermissionPlayer} has a database-entry
	 *
	...
	/**
	 * Creates a new {@link PermissionPlayer} by searching for provided name
	 *
	 * @param name the name of player
	 * @return created player instance
	 */
	@Nullable
	PermissionPlayer getPermissionPlayer(@Nonnull String name);

	/**
	 * Creates a new {@link PermissionPlayer} instance with the
	 * provided default values (Name: {@link String} and uniqueId: {@link UUID})
	 *
