 ...
 * @since SNAPSHOT-1.3
 */
public interface PermissionPlayer extends PermissionEntity, ImmutableNameHolder, ImmutableUUIDHolder {
	...
	/**
	 * Checks if this permissionPlayer has a valid and online
	 * {@link CloudPlayer} instance linked to it
	 *
