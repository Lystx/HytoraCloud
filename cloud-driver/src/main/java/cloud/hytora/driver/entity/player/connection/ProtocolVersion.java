...
public class ProtocolVersion {
	...
	public Collection<String> getAllNames() {
		Collection<String> allNames = new ArrayList<>(Arrays.asList(otherNames));
		allNames.add(name);
		return allNames;
	}
	...
	public static class SwitchResult {
		...
		public static SwitchResult allow() {
			return new SwitchResult(true, null, null);
		}

		public static SwitchResult deny(ProtocolVersion pV, ProtocolVersion sV) {
			return new SwitchResult(false, pV, sV);
		}


		private boolean allowed;
		private ProtocolVersion playerVersion;
