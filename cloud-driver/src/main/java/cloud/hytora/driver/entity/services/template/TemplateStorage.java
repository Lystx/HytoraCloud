...
public interface TemplateStorage {
    ...
    void copyTemplate(@NotNull CloudService server, @NotNull ServiceTemplate template, @NotNull File directory) throws Exception;

    void deleteTemplate(@NotNull ServiceTemplate template);

    void createTemplate(@NotNull ServiceTemplate template);

    void deployService(@NotNull CloudService server, @NotNull ServiceDeployment deployment);
