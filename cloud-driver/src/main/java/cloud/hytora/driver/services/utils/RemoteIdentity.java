...
public class RemoteIdentity {
    ...
    public static RemoteIdentity forApplication(ProtocolAddress address) {
        return new RemoteIdentity(address.getAuthKey(), "", VersionType.BUNGEE, ServiceProcessType.WRAPPER, LogLevel.INFO, address.getHost(), CloudDriver.APPLICATION_NAME, address.getPort());
    }
