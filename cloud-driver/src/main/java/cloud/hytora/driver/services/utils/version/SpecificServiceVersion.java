...
@Getter
public enum SpecificServiceVersion {
    ...
    @SafeVarargs
    SpecificServiceVersion(ServiceVersion serviceVersion, String url, String title, String version, Class<? extends VersionFile>... versionFiles) {
