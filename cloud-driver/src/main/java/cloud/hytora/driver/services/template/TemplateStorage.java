...
public interface TemplateStorage {
    ...
    void copyTemplate(@NotNull ServiceInfo server, @NotNull ServiceTemplate template, @NotNull File directory) throws Exception;

    void deleteTemplate(@NotNull ServiceTemplate template);

    void createTemplate(@NotNull ServiceTemplate template);

    void deployService(@NotNull ServiceInfo server, @NotNull ServiceDeployment deployment);
