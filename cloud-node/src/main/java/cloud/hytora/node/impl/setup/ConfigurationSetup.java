...
public class ConfigurationSetup extends Setup<ConfigurationSetup> {
    ...
    @Question(id = 2, question = "What Parent does this configuration belong to?")
    @QuestionTip("If you don't know what this means, just re-enter the name of the configuration!")
    private String parentName;

    @Question(id = 3, question = "What serversoftware should this configuration use?")
    @RequiresEnum(ServiceVersion.class)
    @AnswerCompleter(EnumSuggester.class)
    private ServiceVersion version;

    @Question(id = 4, question = "Should services of this configuration be dynamic?")
    ...
    @Question(id = 5, question = "How much memory are services of this configuration allowed to use?")
    private int memory;

    @Question(id = 6, question = "How many players are on each service of this configuration allowed to be?")
    private int maxPlayers;

    @Question(id = 7, question = "How many services of this configuration may maximum be online?")
    @QuestionTip("Use -1 for unlimited")
    private int maxServers;

    @Question(id = 8, question = "How many services of this configuration have to be always online?")
    @QuestionTip("Minimum = 1")
    private int minServers;

    @Question(id = 9, question = "On which Node should this configuration run?")
    private String node;

    @Question(id = 10, question = "Which TemplateStorage should Services of this configuration use?")
    ...
    @Question(id = 12, question = "What JavaVersion should this configuration use?")
