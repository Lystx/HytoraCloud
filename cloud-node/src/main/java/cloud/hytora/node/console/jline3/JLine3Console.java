...
public class JLine3Console implements Console {
	...
	public Console forceWrite(@Nonnull String text) {
		return writeRaw(Ansi.ansi().eraseLine(Ansi.Erase.ALL).toString() + '\r' + text + ColorTranslator.RESET);
	}
	...
	public void emptyPrompt() {
		prompt = ColorTranslator.RESET.toString();
		updatePrompt();
	}
